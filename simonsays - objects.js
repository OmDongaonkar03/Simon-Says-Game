//SimonSays.JS
	...
	sequence.push(random.Random1),FirstArr.push(random.Random1);
	sequence.push(random.Random2),FirstArr.push(random.Random2);
	sequence.push(random.Random3),FirstArr.push(random.Random3);
...
function startgame(){
	...
	let optioncolor={
		optioncolor1:document.getElementById('optioncolor1');
		optioncolor2:document.getElementById('optioncolor2');
		optioncolor3:document.getElementById('optioncolor3');
	}
	
	let indexes = [0, 1, 2];
	indexes.sort(() => Math.random() - 0.5);
	
	optioncolor.optioncolor1.style.backgroundColor = sequence[indexes[0]];
	optioncolor.optioncolor2.style.backgroundColor = sequence[indexes[1]];
	optioncolor.optioncolor3.style.backgroundColor = sequence[indexes[2]];
...
function process(element){
	...
	let color={
		colorOne:document.getElementById('optioncolor1').style.backgroundColor;
		colortwo:document.getElementById('optioncolor2').style.backgroundColor;
		colortrd:document.getElementById('optioncolor3').style.backgroundColor;
	}
	
	if(identity=='optioncolor1'){
		if(clickcounter==3){
			document.getElementById('Selectedblock1').style.backgroundColor = color.colorOne;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else if(clickcounter==2){
			document.getElementById('Selectedblock2').style.backgroundColor = color.colorOne;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else{
			document.getElementById('Selectedblock3').style.backgroundColor = color.colorOne;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}
		selectedcolorArr.push(color.colorOne);
	}
	if(identity=='optioncolor2'){
		if(clickcounter==3){
			document.getElementById('Selectedblock1').style.backgroundColor = color.colortwo;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else if(clickcounter==2){
			document.getElementById('Selectedblock2').style.backgroundColor = color.colortwo;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else{
			document.getElementById('Selectedblock3').style.backgroundColor = color.colortwo;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}
		selectedcolorArr.push(color.colortwo);
	}
	if(identity=='optioncolor3'){
		if(clickcounter==3){
			document.getElementById('Selectedblock1').style.backgroundColor = color.colortrd;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else if(clickcounter==2){
			document.getElementById('Selectedblock2').style.backgroundColor = color.colortrd;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}else{
			document.getElementById('Selectedblock3').style.backgroundColor = color.colortrd;
			document.getElementById(identity).style.display = "none";
			clickcounter--
		}
		selectedcolorArr.push(color.colortrd);
	}
}
...
function Next(){
    ...
    optioncolor.optioncolor1.style.display = "flex";
    optioncolor.optioncolor2.style.display = "flex";
    optioncolor.optioncolor3.style.display = "flex";
